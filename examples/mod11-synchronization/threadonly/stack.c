/*******************************************************************************
This module exemplifies a threadsafe stack.  It uses a mutex to coordinate
access to shared data.  It also demonstrates the use of condition variables by
which threads wait for the shared data to change, and by which threads
notify/resume each other when the state has changed.
/******************************************************************************/
